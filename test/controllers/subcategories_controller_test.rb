...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post subcategories_url, params: { subcategory: { category_id: @subcategory.category_id, code: @subcategory.code, name: @subcategory.name } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { category_id: @subcategory.category_id, code: @subcategory.code, name: @subcategory.name } }
